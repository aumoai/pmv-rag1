...
class Config:
    ...
    VECTOR_STORE_TYPE: str = os.getenv("VECTOR_STORE_TYPE", "chroma")  # Options: "chroma", "lancedb", or "faiss"
...
def create_directories():
    ...
    if Config.VECTOR_STORE_TYPE.lower() == "lancedb":
        directories.append(Config.LANCEDB_URI)
